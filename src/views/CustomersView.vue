    ...
    <div v-if="detailOpen" class="drawer">
      ...
      <div class="drawer-body" v-if="detail">
        <div class="detail-hero">
          <div class="flex gap-10">
            <span class="avatar" style="width: 44px; height: 44px; font-size: 17px">{{ initials(detail.name) }}</span>
            <div>
              <div class="serif" style="font-size: 19px; font-weight: 700">{{ detail.name }}</div>
      ...
      <div class="drawer-foot">
        ...
        <button class="btn btn-primary">编辑档案</button>
      </div>
    </div>
